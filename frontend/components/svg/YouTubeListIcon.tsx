...
const YouTubeListIcon:React.FC<Iprops> = ({classModule}) => {
    return <>
        <svg display = 'none'>
                <symbol viewBox="0 0 24 24" id = "YoutubeList-icon">
                    <g>
        ...
        <svg className = {classModule}>
            <use xlinkHref='#YoutubeList-icon'></use>
        </svg>
    </>
}


export default YouTubeListIcon;
